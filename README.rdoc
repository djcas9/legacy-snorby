...
Snorby is not very pretty yet and installing will be an advanced task for the time being. 
Please use the google groups for support and remember to report bugs.
...
Then setup the snorby database and cron jobs:
 ...
 rake snorby:setup ENV=production
