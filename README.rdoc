...
<b>Snorby Is In Beta:</b>

Snorby is not very pretty yet and installing will be an advanced task for the time being. Please use the google groups for support and remember to report bugs.
