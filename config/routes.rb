ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :settings, :collection => { :save_settings => :put, :sensor_delete_multiple => :post, :user_delete_multiple => :post, :administration => :get }
  ...
  map.root :login
  map.resources :searches, :collection => { :auto_complete_for_search_ip_src => :get, :auto_complete_for_search_ip_dst => :get, :auto_complete_for_search_keywords => :get, :send_search_now => :post, :delete_multiple => :post }
